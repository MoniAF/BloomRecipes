app.component('c-password',{
    ...
    <section class="mt-5">
        <p class="title-user justify-content-center mt-5">Identity verification</p>
        ...
        <section class="d-flex justify-content-center m-input">
            ...
            <input class="form-control input-log txt-input mb-3" type="text" placeholder="Username" aria-label="default input example">
        </section>
